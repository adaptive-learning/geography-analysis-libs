...
for SWITCHER in false true; do
    ...
    LOCAL_DEST_DIR=`get_directory`;
    cp ${LOCAL_DEST_DIR}/feedback_by_success.png ${DEST_SIMPLIFIED_DIR}/feedback_by_success_adjustment_${SWITCHER}.png
    cp ${LOCAL_DEST_DIR}/feedback_vs_answers.png ${DEST_SIMPLIFIED_DIR}/feedback_vs_answers_adjustment_${SWITCHER}.png
done;
